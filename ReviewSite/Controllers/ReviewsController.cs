...
namespace ReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,Make,Model,Description,ReleaseDate,Price,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,Make,Model,Description,ReleaseDate,Price,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
